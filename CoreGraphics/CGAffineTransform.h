...
GS_AFTR_SCOPE CGAffineTransform CGAffineTransformMake(CGFloat a, CGFloat b, CGFloat c, CGFloat d, CGFloat tx, CGFloat ty)
{
...
/*
GS_AFTR_SCOPE CGAffineTransform CGAffineTransformMakeTranslation(CGFloat tx, CGFloat ty)
{
    CGAffineTransform matrix;
...
GS_AFTR_SCOPE CGAffineTransform CGAffineTransformConcat(CGAffineTransform t1, CGAffineTransform t2)
{
    CGAffineTransform t;
...
GS_AFTR_SCOPE CGAffineTransform CGAffineTransformTranslate(CGAffineTransform t, CGFloat tx, CGFloat ty)
{
    t.tx += tx * t.a + ty * t.c;
    t.ty += tx * t.b + ty * t.d;
...
GS_AFTR_SCOPE CGAffineTransform CGAffineTransformScale(CGAffineTransform t, CGFloat sx, CGFloat sy)
{
    t.a *= sx;
    t.b *= sx;
    t.c *= sy;
...
GS_AFTR_SCOPE CGAffineTransform CGAffineTransformRotate(CGAffineTransform t, CGFloat angle)
{
...
GS_AFTR_SCOPE CGPoint CGPointApplyAffineTransform(CGPoint point, CGAffineTransform t)
{
    return CGPointMake(t.a * point.x + t.c * point.y + t.tx,
                       t.b * point.x + t.d * point.y + t.ty);
}

GS_AFTR_SCOPE CGSize CGSizeApplyAffineTransform(CGSize size, CGAffineTransform t)
{
    CGSize r;
