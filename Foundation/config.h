/* Headers/config.h.  Generated from config.h.in by configure.  */
/* Headers/config.h.in.  Generated from configure.ac by autoheader.  */
...
#define GNUSTEP_TARGET_CONFIG_FILE "/usr/local/etc/GNUstep/GNUstep.conf"
...
#define GNUSTEP_TARGET_NETWORK_WEB_APPS "/usr/local/lib/GNUstep/WebApplications"

/* Built in default value for GNUstep system apps */
#define GNUSTEP_TARGET_SYSTEM_ADMIN_APPS "/usr/local/lib/GNUstep/Applications"

/* Built in default value for GNUstep system tools */
#define GNUSTEP_TARGET_SYSTEM_ADMIN_TOOLS "/usr/local/sbin"

/* Built in default value for GNUstep system apps */
#define GNUSTEP_TARGET_SYSTEM_APPS "/usr/local/lib/GNUstep/Applications"

/* Built in default value for GNUstep system documentation */
#define GNUSTEP_TARGET_SYSTEM_DOC "/usr/local/share/GNUstep/Documentation"

/* Built in default value for GNUstep system info documentation */
#define GNUSTEP_TARGET_SYSTEM_DOC_INFO "/usr/local/share/info"

/* Built in default value for GNUstep system manpages documentation */
#define GNUSTEP_TARGET_SYSTEM_DOC_MAN "/usr/local/share/man"

/* Built in default value for GNUstep system headers */
#define GNUSTEP_TARGET_SYSTEM_HEADERS "/usr/local/include"

/* Built in default value for GNUstep system libraries */
#define GNUSTEP_TARGET_SYSTEM_LIBRARIES "/usr/local/lib"

/* Built in default value for GNUstep system library */
#define GNUSTEP_TARGET_SYSTEM_LIBRARY "/usr/local/lib/GNUstep"

/* Built in default value for GNUstep system tools */
#define GNUSTEP_TARGET_SYSTEM_TOOLS "/usr/local/bin"
...
#define GNUSTEP_TARGET_SYSTEM_WEB_APPS "/usr/local/lib/GNUstep/WebApplications"
...
/* #undef HAVE_WIDE_PRINTF_FUNCTION */
