...
/*
static void _CACompositorApplyTransform(CALayer *layer)
{
    if (layer->_needsComposite) {
        _CARenderLayerApplyTransform((CARenderLayer *)layer);
    }
    for (CALayer *sublayer in layer->_sublayers) {
        _CACompositorApplyTransform(sublayer);
    }
}*/
...
void _CACompositorPrepareComposite()
{
    ...
    //_CACompositorApplyTransform(rootPresentationLayer->_renderLayer);
    //_CACompositorUpdateCompositeRect(rootPresentationLayer);
